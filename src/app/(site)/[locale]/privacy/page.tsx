...
export async function generateMetadata({
  ...
  const page = legalCopy[locale as SiteLocale].privacy;
  return {
    title: page.title,
    description: fill(page.metaDescription, { domain: siteConfig.domain }),
    alternates: alternatesFor(locale as SiteLocale, "/privacy"),
  };
}
...
export default async function Page({ params }: PageProps) {
  ...
  return <LegalDocument page={legalCopy[locale].privacy} locale={locale} />;
}
